...
public class BusController : MonoBehaviour
{
    ...
    [SerializeField]
    float maxMotorTorque = 3000F; // maximum torque the motor can apply to wheel

    [SerializeField]
    float maxSteeringAngle = 30F; // maximum steer angle the wheel can have
